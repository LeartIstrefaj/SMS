        ...
        <div className="container">
            ...
            <div class="row pushBottom-half">
                <div className="col-sm-12 col-lg-6 h-100 bg-about rounded-3">
                    <p className="paragraph-style">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.

                    </p>
                    <p className="paragraph-style">For our primary restaurant is the pleasure and enjoyment of the clientele
            ...
            <div className="row pushBottom">
                <div className="col-sm-12 col-lg-6">
                    <img className="img-fluid rounded-3 shadow-image-about" src={img2} alt="" />
                </div>
                <div className="col-sm-12 col-lg-6 h-100 bg-about rounded-3">
                    <p className="paragraph-style">Restaurant Leart is part of Gastronomy since 2005, since then we are one
                    ...
                    <p className="paragraph-style">We also count over 70 people in the whole field. Including active staff, cooks, managers etc. The
